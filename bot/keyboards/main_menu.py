...
def payment_kb() -> ReplyKeyboardMarkup:
    ...
    💳 Karta/Paynet — mijozga Paynet link yuboriladi
    🤝 Nasiya       — admin qaror qiladi, alohida ko'rib chiqiladi
    🚶 Borib olaman — o'zi olib ketadi, manzil beriladi
    """
    return ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text="💳 Karta / Paynet")],
            [KeyboardButton(text="🤝 Nasiya (Admin tasdiqlaydi)")],
